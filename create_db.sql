...
CREATE TABLE Album (id VARCHAR(50), name VARCHAR(250), image_url VARCHAR(200), album_type VARCHAR(20), release_date VARCHAR(20), popularity INT(4) UNSIGNED, PRIMARY KEY(id));
CREATE TABLE Artist (id VARCHAR(50), name VARCHAR(200), image_url VARCHAR(200), followers INT(10), popularity INT(4) UNSIGNED, PRIMARY KEY(id));
