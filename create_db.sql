...
CREATE TABLE Album (id VARCHAR(50), name VARCHAR(250), album_type VARCHAR(20), release_date VARCHAR(20), popularity INT(10) UNSIGNED, PRIMARY KEY(id));
CREATE TABLE Artist (id VARCHAR(50), name VARCHAR(100), popularity INT(10) UNSIGNED, PRIMARY KEY(id));
CREATE TABLE Track (id VARCHAR(50), name VARCHAR(250), duration_ms INT(10) UNSIGNED, explicit BOOLEAN, popularity INT(10) UNSIGNED, PRIMARY KEY(id));
